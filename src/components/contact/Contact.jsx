...
export default function Contact() {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_cw86qve', 'template_ezc0n4o', form.current, 'AGCDseXcLXFPngpy-')
        e.target.reset()
    };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">7989008233</span>
                        <a href="https://api.whatsapp.com/send?phone=7989008233&text=Hello, more information!" className="contact__button">Write me
                        <i className="bx bx-right-arrow-alt"></i></a>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">syed-khasim</span>
                        <a href="https://www.linkedin.com/in/syed-khasim/" className="contact__button">Write me
                        <i className="bx bx-right-arrow-alt"></i></a>
